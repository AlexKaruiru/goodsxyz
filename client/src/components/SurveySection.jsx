      ...
      <Container maxW="1200px" px={{ base: 0, md: 6 }}>
        <VStack spacing={8} align="stretch" px={{ base: 4, md: 0 }}>
          <Heading size="xl" textAlign="center" mb={4} color="gray.800">
            Need Flekosteel? Complete this survey:
          </Heading>
          ...
          {currentQuestion < questions.length ? (
            ...
            <Box p={10} bg="blue.50" borderRadius="xl" boxShadow="md">
              <Text fontSize="xl" lineHeight="tall" color="gray.700">
                ...
                <Text as="span" fontWeight="bold" color="brandBlue">Flekosteel</Text> which alleviates sprains, 
                contusions and even osteoarthritis. The unique capability of{' '}
                <Text as="span" fontWeight="bold" color="brandBlue">Flekosteel</Text> to relieve pain and inflammation 
